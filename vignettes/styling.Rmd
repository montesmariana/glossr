...
Moreover, the `styling` argument can take two other elements.
...
Finally, "par_spacing" (also to be set as `options(glossr.par.spacing = 0)`) defines the space above and below the glosses, which by default is 0. Depending on the normal settings of your template, you might want to add more spacing.
