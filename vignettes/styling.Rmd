...
between the different parts of a gloss. In all cases the default value is `0`, but you can increase them or reduce them by providing the desiderd value to the appropriate item under the `pdf` section.
