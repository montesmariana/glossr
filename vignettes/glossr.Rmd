...
The package also takes care of cross-references, giving you a handy function `gloss()` to sprinkle around your text every time you want to reference one of your examples. Go ahead and check out the articles, particularly `vignette("glossr_leipzig")` for HTML rendering and the [PDF version](https://github.com/montesmariana/glossr/raw/main/inst/pdf/glossr_pdf.pdf).
