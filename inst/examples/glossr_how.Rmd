...
and `officedown::rdocx_document`, which renders [an MS Word file]((https://github.com/montesmariana/glossr/raw/main/inst/pdf/glossr_how.word)) [@R-bookdown; @R-officedown]. As you can see in `vignette("styling")`, `use_glossr()` also takes some variables to set up document-wide styling options for specific parts of your glosses. The code below sets the name of the source to render in boldface and the first line of each gloss in italics.
